      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 my-12 gap-5 w-full">
        <div className="flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl shadow-black-200">
          ...
          <div className="flex items-center justify-between flex-wrap gap-5">
            ...
            <a className="flex items-center cursor-pointer gap-2 text-white-600">
              <p href={currentProject.href} target="_blank">
                Check Live Site
              </p>
              <img
        ...
        <div className="border vorder-black-300 bg-black-200 rounded-lg h-96 md:h-full">
          <Canvas>
